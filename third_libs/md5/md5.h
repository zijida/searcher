...
#define MD5_T64  0xeb86d391 //Transformation Constant 64
	...
	public:
		...
		static void getmd5(BYTE* pBuf, UINT nLength,unsigned char* arrmd5);
		//static void getmd5(CFile& File,unsigned char* arrmd5);
		static void getmd5(std::string& context,unsigned char* arrmd5);
	...
	protected:
		...
		void final(unsigned char* arrmd5);
		inline UINT4 rotate(UINT4 x, int n);
		inline void FF( UINT4& A, UINT4 B, UINT4 C, UINT4 D, UINT4 X, UINT4 S, UINT4 T);
		inline void GG( UINT4& A, UINT4 B, UINT4 C, UINT4 D, UINT4 X, UINT4 S, UINT4 T);
		inline void HH( UINT4& A, UINT4 B, UINT4 C, UINT4 D, UINT4 X, UINT4 S, UINT4 T);
		inline void II( UINT4& A, UINT4 B, UINT4 C, UINT4 D, UINT4 X, UINT4 S, UINT4 T);

		//utility functions
		void dword2byte(BYTE* Output, UINT4* Input, UINT nLength);
		void byte2dword(UINT4* Output, BYTE* Input, UINT nLength);
